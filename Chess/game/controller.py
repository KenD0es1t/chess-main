...
def controller(pieceCoordinates,board,turn,movedStatus,enPassant):
    ...
    # ----
    return getLegalMoves(pieceCoordinates, board,kingMoves=kingMoves,getOutOfCheckMoves=getOutOfCheckMoves,pinnedLegalMoves=pinnedLegalMoves,castleMoves=castleMoves,enPassantMove=enPassantMove), isCheck, False